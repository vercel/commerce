...
const CheckoutSidebarView: FC = () => {
  ...
  const { paymentMethodDetails, setPaymentMethodDetails, setSidebarView, closeSidebar } = useUI()
    ...
    >
      ...
      >
        <ul className="pb-2">
          ...
          <li className="flex justify-between py-1">
            <span>Taxes</span>
            <span>{cartData.taxes ? taxes : 'Calculated at checkout'}</span>
          </li>
          <li className="flex justify-between py-1">
            <span>Shipping</span>
