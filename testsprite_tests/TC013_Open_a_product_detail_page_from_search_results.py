...
async def run_test():
    ...
    try:
        ...
        # -> Verify element 'Product results list' is visible by finding a known product title, then click the first product card in the results.
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Product results list').first).to_be_visible(timeout=3000)
