...
async def run_test():
    ...
    try:
        ...
        # -> Click the first collection link in the collections list (the 'Automated Collection' link).
        ...
        await expect(frame.locator('text=Product image gallery').first).to_be_visible(timeout=3000)
