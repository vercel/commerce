...
export default function CartModal() {
  ...
  // The drawer portals to <body>: the sticky navbar's backdrop-blur makes it
  // the containing block for fixed descendants, which would trap and clip
  // the panel inside the nav bounds.
